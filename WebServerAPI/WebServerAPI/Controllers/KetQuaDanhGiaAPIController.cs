...
namespace WebServerAPI.Controllers
{
    public class KetQuaDanhGiaAPIController : ApiController
    {
        ...
        /// <returns></returns>
        [HttpGet]
        public IEnumerable<KetQuaDanhGia_Circle_> GetKetQuaDanhGiaAll(int _MaBP)
        {
        ...
        /// <returns></returns>
        [HttpGet]
        public IEnumerable<KetQuaDanhGia_Circle_> GetKetQuaDanhGiaAllThoiGian(int _MaBP, string _ThoiGian)
        {
